...
//{
	...
	struct __hashTableIterator
	{
		...
		typedef __hashTableIterator<key, value, keyOfValue, hash> self;

		node* _node;
		hashTable* _ht;

		__hashTableIterator(node* node, hashTable* ht)
			:_node(node)
			, _ht(ht)
		{}
	...
	public:
		typedef __hashTableIterator<key, value, keyOfValue, hash> iterator;
		iterator begin()
		{
			size_t hashi = 0;
